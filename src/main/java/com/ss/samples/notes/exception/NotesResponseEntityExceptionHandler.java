...
public class NotesResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleAllException(Exception ex, WebRequest request) throws Exception {
		NotesExceptionResponse exResp = new NotesExceptionResponse(new Date(), ex.getMessage(),
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		NotesExceptionResponse exResp = new NotesExceptionResponse(new Date(), "Validation Failed",
